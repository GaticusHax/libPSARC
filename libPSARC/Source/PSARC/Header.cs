...
namespace libPSARC.PSARC {
    ...
    public struct Header {
        ...
        [StructMeta( ToStringMethod = "_magicToString" )]
        /* 0x00 [0x04] */
        public readonly char[] magic;
        private string _magicToString() => new string( magic );
        ...
        /* 0x04 [0x02] */
        public UInt16 VersionMajor => (UInt16) ((version & 0xFFFF0000) >> 16);
        /// <summary>PSARC file format version minor.</summary>
        /* 0x06 [0x02] */
        public UInt16 VersionMinor => (UInt16) (version & 0x0000FFFF);
