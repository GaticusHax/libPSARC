...
namespace libPSARC {
    ...
    [Flags] public enum ArchiveFlags : uint {
...
namespace libPSARC.PSARC {
    ...
    public struct Header {
        internal static readonly uint MAGIC = BitConverter.ToUInt32( Encoding.ASCII.GetBytes( "PSAR" ), 0 );
        internal const uint VERSION = (1 << 16) + 4;

        /// <summary>Should always be "PSAR".</summary>
        //[MarshalAs( UnmanagedType.ByValArray, SizeConst = 4 )]
        [StructMeta( ToStringMethod = "_magicToString" ), ByteOrder( Endian.Little )]
        /* 0x00 [0x04] */ public readonly uint magic;
        ...
        /* 0x04 [0x04] */ public readonly uint version;
        ...
        /* 0x04 [0x02] */ public ushort VersionMajor => (ushort) ((version & 0xFFFF0000) >> 16);
        /// <summary>PSARC file format version minor.</summary>
        /* 0x06 [0x02] */ public ushort VersionMinor => (ushort) (version & 0x0000FFFF);
